<template>
  <div>
    <el-menu :default-active="activeIndex" router class="el-menu-demo" mode="horizontal" background-color="#1a237e"
      ...
      <el-menu-item style="border: none;" index="/admin"><img src="@/assets/logo.png"
          height="30px" />{{ $sysTitle }}后台</el-menu-item>
      ...
      <el-menu-item index="/admin/orders">入住管理</el-menu-item>
